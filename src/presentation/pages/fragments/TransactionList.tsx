...
import { IconArrowDownLeft, IconArrowRight, IconArrowUpRight } from "~/presentation/assets";
import { SkeletonLoading } from "~/presentation/components/SkeletonLoading";
import { Text } from "~/presentation/components/Text";
import { borderRadius, colors, spaces, width } from "~/presentation/settings/themes";

export function TransactionList() {
	const { t } = useTranslation();
	const { data, status } = useUser(state => state.transactions);
